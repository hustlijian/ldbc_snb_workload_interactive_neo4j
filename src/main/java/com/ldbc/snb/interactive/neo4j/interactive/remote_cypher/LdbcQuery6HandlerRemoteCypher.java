...
public class LdbcQuery6HandlerRemoteCypher extends OperationHandler<LdbcQuery6> {
    private static final Neo4jQuery6RemoteCypher query = new Neo4jQuery6RemoteCypher();
