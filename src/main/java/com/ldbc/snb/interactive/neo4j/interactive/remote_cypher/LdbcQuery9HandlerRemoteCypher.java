...
public class LdbcQuery9HandlerRemoteCypher extends OperationHandler<LdbcQuery9> {
    private static final Neo4jQuery9RemoteCypher query = new Neo4jQuery9RemoteCypher();
    ...
    protected OperationResultReport executeOperation(LdbcQuery9 operation) throws DbException {
        ...
        List<LdbcQuery9Result> result = null;
        int resultCode = 0;
        try {
