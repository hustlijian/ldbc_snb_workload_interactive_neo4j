...
//                                (long) input.get("birthday"),
//                                (long) input.get("creation"),
//                                (String) input.get("gender"),
//                                (String[]) input.get("languages"),
//                                (String) input.get("browser"),
//                                (String) input.get("ip"),
//                                (String[]) input.get("emails"),
//                                (String) input.get("personCity"),
//                                (Collection<String>) input.get("unis"),
//                                (Collection<String>) input.get("companies"));
    ...
    private String query() {
        return String.format(""
                ...
                + "MATCH (uniCity:" + Place.Type.City + ")<-[:" + Rels.IS_LOCATED_IN + "]-(uni:" + Organisation.Type.University + ")<-[studyAt:" + Rels.STUDY_AT + "]-(person)\n"
                + "WITH collect(DISTINCT (uni." + Organisation.NAME + " + ', ' + uniCity." + Place.NAME + "+ '(' + studyAt." + StudiesAt.CLASS_YEAR + " + ')')) AS unis,\n"
                + "  person, personCity\n"
                + "MATCH (companyCountry:" + Nodes.Place + ":" + Place.Type.Country + ")<-[:" + Rels.IS_LOCATED_IN + "]-(company:" + Organisation.Type.Company + ")<-[worksAt:" + Rels.WORKS_AT + "]-(person)\n"
                + "WITH collect(DISTINCT (company." + Organisation.NAME + " + ', ' + companyCountry." + Place.NAME + " + '('+ worksAt." + WorksAt.WORK_FROM + " + ')')) AS companies,\n"
