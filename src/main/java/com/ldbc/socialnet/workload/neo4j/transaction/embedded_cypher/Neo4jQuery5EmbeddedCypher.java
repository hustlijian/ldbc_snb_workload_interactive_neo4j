...
public class Neo4jQuery5EmbeddedCypher implements Neo4jQuery5 {
    ...
    public Iterator<LdbcQuery5Result> execute(GraphDatabaseService db, ExecutionEngine engine, LdbcQuery5 operation) {
        ...
        List<LdbcQuery5Result> postsAndComments = Lists.newArrayList(postsAndCommentsMap.values().iterator());
    ...
    private String queryComments() {
        return "MATCH (person:" + Domain.Nodes.Person + ")-[:" + Domain.Rels.KNOWS + "*1..2]-(friend:"
                + Domain.Nodes.Person + ")\n"
                ...
                + "MATCH (friend)<-[:" + Domain.Rels.HAS_CREATOR + "]-(comment:" + Domain.Nodes.Comment + ")\n"

                + "WHERE (comment)-[:" + Domain.Rels.REPLY_OF + "*0..]->(:" + Domain.Nodes.Comment + ")-[:"
                + Domain.Rels.REPLY_OF + "]->(:" + Domain.Nodes.Post + ")<-[:" + Domain.Rels.CONTAINER_OF + "]-(forum)\n"
    ...
    private String queryPosts() {
        return "MATCH (person:" + Domain.Nodes.Person + ")-[:" + Domain.Rels.KNOWS + "*1..2]-(friend:"
                ...
                + Domain.Rels.CONTAINER_OF + "]-(forum)\n"
