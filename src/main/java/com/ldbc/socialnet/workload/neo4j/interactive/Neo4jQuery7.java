...
public abstract class Neo4jQuery7<CONNECTION> implements Neo4jQuery<LdbcQuery7, LdbcQuery7Result, CONNECTION> {
    ...
    protected static final String QUERY_STRING = ""
            ...
            + " like." + Domain.Likes.CREATION_DATE + " AS likeDate,  NOT((person)-[:" + Domain.Rels.KNOWS + "]-(start)) AS isNew, post." + Domain.Message.ID + " AS postId,"
            + " post." + Domain.Message.CONTENT + " AS postContent, like." + Domain.Likes.CREATION_DATE + " - post." + Domain.Message.CREATION_DATE + " AS latency\n"
