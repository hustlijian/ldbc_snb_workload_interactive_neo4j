...
public abstract class Neo4jQuery9<CONNECTION> implements Neo4jQuery<LdbcQuery9, LdbcQuery9Result, CONNECTION> {
    ...
    protected static final String QUERY_STRING = ""
            ...
            + "MATCH (friend)<-[:" + Domain.Rels.HAS_CREATOR + "]-(activity) WHERE activity." + Domain.Post.CREATION_DATE + " < {" + LATEST_DATE + "}\n"
            + "RETURN DISTINCT"
            + " activity." + Domain.Post.ID + " AS activityId,"
            + " activity." + Domain.Post.CONTENT + " AS activityContent,"
            + " activity." + Domain.Post.CREATION_DATE + " AS activityCreationDate,"
