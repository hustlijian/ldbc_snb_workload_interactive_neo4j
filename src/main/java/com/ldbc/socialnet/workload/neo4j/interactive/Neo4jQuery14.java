...
public abstract class Neo4jQuery14<CONNECTION> implements Neo4jQuery<LdbcQuery14, LdbcQuery14Result, CONNECTION> {
    ...
    protected static final String QUERY_STRING = ""
            ...
            + "RETURN extract(n IN pathNodes | n.id) AS pathNodeIds, reduce(weight=0.0, idx IN range(1,size(pathNodes)-1) |\n"
            ...
            + "            length((curr)<-[:" + Rels.HAS_CREATOR + "]-(:" + Nodes.Comment + ")-[:" + Rels.REPLY_OF + "]->(:" + Nodes.Comment + ")-[:" + Rels.HAS_CREATOR + "]->(prev))*0.5 +\n"
