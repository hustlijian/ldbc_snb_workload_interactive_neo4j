...
public class Queries
{
    public static class LdbcInteractive
    {
        ...
        public static final String QUERY_1_TEMPLATE = String.format(
        ...
        Domain.Person.FIRST_NAME, Domain.Person.LAST_NAME, Domain.Person.BIRTHDAY, Domain.Person.CREATION_DATE,
                ...
                Domain.Person.EMAIL_ADDRESSES, Domain.Place.NAME, Domain.Organisation.NAME,
                Domain.StudiesAt.CLASS_YEAR, Domain.Place.NAME, Domain.Organisation.NAME, Domain.WorksAt.WORK_FROM,
                Domain.Place.NAME );

        public static final Map<String, Object> query1Params( String firstName )
        {
        ...
        public static final String QUERY_3_TEMPLATE_x = String.format(
        ...
        public static final String QUERY_3_TEMPLATE = String.format(
        ...
        public static final Map<String, Object> query2Params( long personId, String countryX, String countryY,
        ...
        public static final String QUERY_4_TEMPLATE = String.format(
        ...
        "MATCH (person:" + Domain.Node.PERSON + ")-[:" + Domain.Rel.KNOWS + "]-(friend:" + Domain.Node.PERSON + ")<-[:"
                ...
                + "RETURN tag." + Domain.Tag.NAME + ", count(tag) AS tagCount\n"
        ...
        public static final Map<String, Object> query4Params( long personId, Date startDate, int durationDays )
        {
            Calendar c = Calendar.getInstance();
            c.setTime( startDate );
            c.add( Calendar.DATE, -durationDays );
