...
public class QueryPerformanceTest
{
    ...
    public void query1api()
    {
        ...
        {
            Operation operation = new LdbcQuery1( "Joan", 10 );
            Neo4jQuery query = new Neo4jQuery1EmbeddedApi( new LdbcTraversersSteps( db ) );
    ...
    public void query3api()
    {
        try (Transaction tx = db.beginTx())
        {
            ...
            Neo4jQuery query = new Neo4jQuery3EmbeddedApi( new LdbcTraversersSteps( db ) );
    ...
    public void query4api()
    {
        try (Transaction tx = db.beginTx())
        {
            ...
            Operation operation = new LdbcQuery4( personId, endDate, durationDays );
            Neo4jQuery query = new Neo4jQuery4EmbeddedApi( new LdbcTraversersSteps( db ) );
