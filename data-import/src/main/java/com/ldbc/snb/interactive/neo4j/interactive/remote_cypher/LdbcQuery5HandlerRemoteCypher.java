...
public class LdbcQuery5HandlerRemoteCypher extends OperationHandler<LdbcQuery5> {
    private static final Neo4jQuery5RemoteCypher query = new Neo4jQuery5RemoteCypher();
